...
void sub_31BE8(s16 arg0)
{
    ...
    {
        DmaCopy16(3, gCurrentPinballGame_unk40.unk2C[arg0], (void*)OBJ_PLTT, 0x20);
    }

    if (gMain.selectedField == FIELD_SAPPHIRE)
    {
        DmaCopy16(3, gCurrentPinballGame_unk40.unk2C[arg0] + 0x10, (void*)OBJ_PLTT + 0x40, 0xC0);
    }
    else
    {
        DmaCopy16(3, gCurrentPinballGame_unk40.unk2C[arg0] + 0x10, (void*)OBJ_PLTT + 0x40, 0xE0);
    }

    DmaCopy16(3, gCurrentPinballGame_unk40.unk2C[arg0] + 0x50, (void *)OBJ_PLTT + 0x140, 0x20);
