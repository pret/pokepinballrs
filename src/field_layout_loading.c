...
extern const struct FieldLayout gUnknown_086AFD70[];
...
void loadIntroduction(void)
{
	...
	case FIELD_RUBY:
        ...
        LZ77UnCompWram(gUnknown_08250934, gBgTilemapBuffer);
	...
	case FIELD_SAPPHIRE:
        ...
        LZ77UnCompWram(gUnknown_082D8998, gBgTilemapBuffer);
    ...
    gBoardConfig.flipperCollisionData = gUnknown_0816C3E4;
}

void SetBoardFieldCollisionData(s16 arg0)
{
    gBoardConfig.fieldLayout.collisionTileMap[0] = gUnknown_086AFCB0[gMain.selectedField][arg0].collisionTileMapData;
    gBoardConfig.fieldLayout.collisionPropertyMap[0] = gUnknown_086AFCB0[gMain.selectedField][arg0].collisionPropertyData;
    gBoardConfig.fieldLayout.collisionSubtypeMap[0] = gUnknown_086AFCB0[gMain.selectedField][arg0].collisionSubtypeData;
}

void UpdateBgTilemapOnScroll(void)
{
    s16 r4;
    const s16 *r3;
    ...
    if (r4 == gCurrentPinballGame->tilemapRowIndex)
        return;
    ...
    if (r4 > gCurrentPinballGame->tilemapRowIndex)
    {
        if (r3[0] > 31)
        {
            DmaCopy16(3, &gBgTilemapBuffer[(r3[0] - 32) * 0x400], (void *)0x06008000 + r3[1] * 0x400, 0x400);
        }
        else
        {
    ...
    else
    {
        if (r3[2] > 31)
        {
            DmaCopy16(3, &gBgTilemapBuffer[(r3[2] - 32) * 0x400], (void *)0x06008000 + r3[3] * 0x400, 0x400);
        }
        else
        {
    ...
    gCurrentPinballGame->tilemapRowIndex = r4;
}
