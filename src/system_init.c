...
s16 InitOamFromSpriteSets(const struct SpriteSet *const *spriteSets, u16 numSpriteSets, struct SpriteGroup *spriteGroups)
{
...
void ResetDisplayAndCallbacks(void)
{
    ResetSerialIO();
    REG_IME = 0;
    ResetMainCallback();
