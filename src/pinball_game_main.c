...
void sub_4B678(u16 arg0)
{
    ...
    if (gMain.selectedField <= FIELD_SAPPHIRE)
    {
        for (i = 0; i < 22; i++)
        {
            ...
            var0 = gCurrentPinballGame->unk64 + i;
            var1 = gCurrentPinballGame->unk64 + 10;
            var2 = (var1) % 22;
            if (var0 < 32)
            {
                DmaCopy16(3, &gUnknown_0200FBB0[var0], (void *)0x6008000 + var2 * 0x400, 0x400);
            }
            else
            {
                var0 -= 32;
                DmaCopy16(3, &gUnknown_020030A0[var0], (void *)0x6008000 + var2 * 0x400, 0x400);
            }
        }
    }
