...
static u8 CheckGameBoyPlayer(void)
{
    ...
    prevDetectedFrame = 0;
    VBlankIntrWait();
    DmaCopy16(3, gGbPlayerGfx, BG_TILE_ADDR(TILE_INDEX(2,0,0)), BG_CHAR_SIZE);
    DmaCopy16(3, gGbPlayerPalettes, BG_PLTT, BG_PLTT_SIZE);
    DmaCopy16(3, gGbPlayerTilemap, gGbPlayerTilemapBuffer, 0x500);
    DmaCopy16(3, gGbPlayerTilemapBuffer, BG_TILE_ADDR(TILE_INDEX(0,0,0)), BG_SCREEN_SIZE);
    ...
    label:
        ...
        VBlankIntrWait();
        {
            ...
            dmaRegs[1] = (vu32)BG_TILE_ADDR(TILE_INDEX(0,0,0));
