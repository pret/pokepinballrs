...
void sub_1642C(u8 arg0, u16* arg1, u16* arg2) 
{
    ...
    case 0:
        ...
        {    
            if (gCurrentPinballGame->ball->positionQ1.x > 199)
    ...
    case 3:
        ...
        {
            if (gCurrentPinballGame->ball->positionQ0.y <= 259) 
            {
                if (gCurrentPinballGame->ball->positionQ0.x <= 73) 
                {
                    if (gCurrentPinballGame->unk13 <= 2 && gCurrentPinballGame->unk36A[1] <= 2)
                    {
                        ...
                        memcpy((void* ) (&gCurrentPinballGame->unk1334[1]), (void* ) (&gCurrentPinballGame->unk1334[0]), 0x44U);
                        
                        gCurrentPinballGame->unk1330 = &gCurrentPinballGame->unk1334[1];
                        gCurrentPinballGame->unk1328 = 25;
                    }
                } 
                else if (gCurrentPinballGame->ball->positionQ0.x <= 115) 
                {
                    if (gCurrentPinballGame->unk13 <= 2 && gCurrentPinballGame->unk36A[0] <= 2)
                    {
            ...
            {     
                if (gCurrentPinballGame->ball->positionQ0.x <= 109) 
                {
    ...
    case 5:
        if (gCurrentPinballGame->ball->positionQ0.x <= 119) 
        {
            if (gCurrentPinballGame->ball->velocity.y > 0) 
            {
                ...
                temp = Sqrt(temp * 4) / 2;
                gCurrentPinballGame->ball->velocity.x = temp * Cos(angle) / 20000;
                gCurrentPinballGame->ball->velocity.y = -temp * Sin(angle) / 20000;
            }
        } 
        else
    ...
    case 12:
        ...
        ix = gUnknown_086ACE70[gCurrentPinballGame->unk34A];
        gCurrentPinballGame->unk34B[ix] = 10;
        ...
        if (gCurrentPinballGame->unk34A == 3) 
        {
            ...
            if (gCurrentPinballGame->unk342 != 0)
        ...
        if (ix == 0 && gCurrentPinballGame->ball->velocity.y > -120)
            gCurrentPinballGame->ball->velocity.y = -120;
        
        if (ix != 2 || gCurrentPinballGame->ball->velocity.y <= -180) 
            return;
    ...
    case 13:
        ...
        if (ix == 1 && gCurrentPinballGame->ball->velocity.y > -150) 
            gCurrentPinballGame->ball->velocity.y = -150;
        
        return;
    case 14:
        if (gCurrentPinballGame->ball->positionQ0.y <= 79) 
        {
