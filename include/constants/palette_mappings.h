...
#define PAL_IX_CATCH_MON 13 // Also hatch mon, Jirachi, and Jirachi fx
#define PAL_IX_LOCATION_PORTRAIT 13
#define PAL_IX_MON_PORTRAIT 13
#define PAL_IX_INITIAL_LOCATION_SELECTION_FX 14
