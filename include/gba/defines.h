...
#define TILE_INDEX(x, y, width) \
    ((y) * (width) + (x))

#define BG_SCREENBLOCK_WIDTH  32
#define BG_SCREENBLOCK_HEIGHT 32
#define BG_SCREENBLOCK_ENTRIES \
    (BG_SCREENBLOCK_WIDTH * BG_SCREENBLOCK_HEIGHT)
